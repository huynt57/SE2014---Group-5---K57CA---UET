	                        ...
	                        <div class="g-form-group-rows">
	                            <div class="g-form-row" style="margin: 5px 0 5px 0; padding: 0;">
	                                <div class="g-form-row-field">
	                                    <div class="g-input">
	                                        <textarea name="contact_message" id="contact_message" cols="30" rows="10"  style="border-color: #429EDB"></textarea>
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="g-form-row">
	                                <div class="g-form-row-field">
	                                    <button class="g-btn type_primary size_small">Đăng tin</button>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
